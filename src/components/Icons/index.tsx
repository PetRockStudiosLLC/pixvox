...
export const IconEyeOff = ({ size, className }: IconProps) => (
  <Icon size={size} className={className}>
    <path
      d="M3 5L13 11M4 3C4 3 3 3.5 3 5.5M12 13C12 13 13 12.5 13 10.5M2 10C2 10 3.5 13 8 13C10 13 11.5 12 12.5 11M6 4C7 3.5 8 3.5 9 4"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
export const IconUnlock = ({ size, className }: IconProps) => (
  <Icon size={size} className={className}>
    <rect x="3" y="7" width="10" height="7" rx="1.5" stroke="currentColor" strokeWidth="1.2" />
    <path
      d="M5 7V5C5 3.5 6 2.5 8 2.5C9.5 2.5 10.5 3.2 11 4"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
export const IconSave = ({ size, className }: IconProps) => (
  <Icon size={size} className={className}>
    <path
      d="M12 14H4C3 14 2 13 2 12V4C2 3 3 2 4 2H10L14 6V12C14 13 13 14 12 14Z"
      stroke="currentColor"
      strokeWidth="1.2"
    />
...
export const IconUndo = ({ size, className }: IconProps) => (
  <Icon size={size} className={className}>
    <path
      d="M4 6H10C12 6 14 8 14 10C14 12 12 14 10 14H6"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
export const IconSettings = ({ size, className }: IconProps) => (
  <Icon size={size} className={className}>
    ...
    <path
      d="M8 2V4M8 12V14M2 8H4M12 8H14M3.5 3.5L5 5M11 11L12.5 12.5M12.5 3.5L11 5M5 11L3.5 12.5"
      stroke="currentColor"
      strokeWidth="1.2"
      strokeLinecap="round"
    />
