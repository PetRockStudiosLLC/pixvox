        ...
        {toasts.map(t => (
          <div
            ...
            className={`pointer-events-auto px-4 py-2.5 rounded-md shadow-lg border text-sm font-medium cursor-pointer animate-slide-up backdrop-blur-md ${
              t.type === 'success' ? 'bg-success/20 border-success/40 text-green-300' :
              t.type === 'error' ? 'bg-danger/20 border-danger/40 text-red-300' :
              t.type === 'warning' ? 'bg-warning/20 border-warning/40 text-yellow-300' :
