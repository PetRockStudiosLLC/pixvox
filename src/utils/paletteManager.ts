...
function getDefaultPalettes(): ColorPalette[] {
  return [
    ...
    {
      name: 'Sweet 16',
      colors: ['#1A1C2C', '#5D275D', '#B13E53', '#EF7D57', '#FFCD75', '#A7F070', '#38B764', '#257179',
        '#29366F', '#3B5DC9', '#41A6F6', '#73EFF7', '#F4F4F4', '#94B0C2', '#566C86', '#333C57'],
      createdAt: Date.now()
    },
    {
      name: 'Arne 16',
      colors: ['#000000', '#BE2633', '#E06F8B', '#493C2B', '#A46422', '#EB8931', '#F7E26B', '#2F484E',
        '#44891A', '#6ABE30', '#8EC527', '#1B2632', '#005784', '#31A2F2', '#B2DCEF', '#FFFFFF'],
      createdAt: Date.now()
    }
  ];
}
